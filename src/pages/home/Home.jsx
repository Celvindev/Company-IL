          ...
          <div className="mr-5 w-[100%]">
            <div className="grid w-[615px] h-[511px] bgrd bg-gray-925 rounded-[33px] px-10 py-8 shadow ">
              ...
              <div className="w-[203px] h-[47px] justify-start items-start inline-flex">
                <div className="w-[203px] h-[47px] px-2 py-[18px] bg-sky-925 bg-opacity-0 rounded-[44px] justify-center items-center flex border border-gradient">
            ...
            <div className="grid w-[615px] h-[197px] mt-5 bgrd bg-gray-925 rounded-[33px] place-items-center shadow">content2</div>
          </div>
          <div className="mr-5 w-[100%]">
            <div className="grid w-[100%] h-[723px] bgrd bg-gray-925 rounded-[33px] place-items-center shadow">Content3</div>
          </div>
        </div>
        <div className="flex w-full justify-center mt-5">
          <div className="grid w-[100%] h-[248px] bgrd bg-gray-925 rounded-[33px] place-items-center shadow">Content4</div>
        </div>
        <div className="flex w-full justify-center mt-5">
