      ...
      <div className='flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 py-6 mx-auto max-w-screen-xl'>
        <div className="flex w-full justify-center">
          <div className="mr-5 w-[100%]">
            <div className="grid w-[615px] h-[511px] card bg-gray-925 rounded-[33px] px-10 py-8 shadow border-white">
              ...
              <div className="w-[203px] h-[47px] justify-start items-start inline-flex">
                <div className="w-[203px] h-[47px] px-2 py-[18px] bg-sky-925 bg-opacity-0 rounded-[44px] border border-white justify-center items-center flex border border-gradient">
                  <div className="text-neutral-900 text-white text-base font-['SF Pro']">MSIB<i className="fa-solid fa-arrow-right ml-2"></i> </div>
                </div>
              </div>
              <div className="w-[203px] h-[47px] justify-start items-start inline-flex">
                <div className="w-[203px] h-[47px] px-2 py-[18px] bg-sky-925  rounded-[44px] justify-center items-center flex border border-gradient">
                  <div className="text-neutral-900 text-white text-base font-['SF Pro']">Regular Courses<i className="fa-solid fa-arrow-right ml-2"></i> </div>
                </div>
              </div>
            </div>
