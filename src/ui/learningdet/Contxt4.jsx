  ...
  return (
    <>
      <div className="team-heading text-center w-[1280px]">
        <h1 className=" text-white text-white font-['Poppins']"> Our Mentee Project</h1>
      </div>
      ...
      <div className="flex w-aut0 mb-64 ">
        ...
        <div className="lear-heading text-left ml-16 -mt-20">
            <h1 className=" text-white text-white font-['Poppins']"> Laundry Pro</h1>
            <article className=" text-white justify-center text-white text-[19px] font-['Poppins'] w-[556px]">
