    ...
    return (
        <>
            ...
            <div className="flex w-full justify-center mt-10">
                <div className="mr-5 w-[100%]">
                <div className="card cardhome w-[100%] h-[357px]  rounded-[44px] image-full">
                        <figure><img src="/assets/msib/Web Developer.JPG" alt="Shoes" /></figure>
                        <div className="card-body">
            ...
            <div className="flex w-full justify-center mt-10">
                ...
                <div className="card cardhome w-[100%] h-[357px]  rounded-[44px] image-full">
                        ...
                        <div className="card-body">
                            <h4 className="card-title text-white ml-5 mt-5">MAGANG<img src='/assets/home/iconarrowup.svg' alt="" className="absolute right-0 mr-5" /></h4>
                                <h1 className="text-left ml-5 mt-10 text-white text-[30px] font-bold font-['Montserrat']">Community and Acquisition</h1>
                                <button className="w-[130px] h-[50px] rounded-[44px] items-center mt-60 right-0 absolute mr-10 m-1 btn btcat btn-outline">
                                <a href="https://kampusmerdeka.kemdikbud.go.id/program/magang/browse/863c3409-8b4e-4c96-9edd-71ee61e9fc41/846d28ec-e0f3-11ee-9fa7-1e338b798a67">
                                    <p className="msibtxtcont">Apply Now</p>
                                    </a>
                                </button>
                        </div>
                ...
                <div className="mr-5 w-[100%]">
                   <div className="card cardhome w-[100%] h-[357px]  rounded-[44px] image-full">
                        ...
                        <div className="card-body">
                            <h4 className="card-title text-white ml-5 mt-5">MAGANG<img src='/assets/home/iconarrowup.svg' alt="" className="absolute right-0 mr-5" /></h4>
                                <h1 className="text-left ml-5 mt-10 text-white text-[30px] font-bold font-['Montserrat']">Human Management</h1>
                                <button className="w-[130px] h-[50px] rounded-[44px] items-center mt-60 right-0 absolute mr-10 m-1 btn btcat btn-outline">
                                   <a href="https://kampusmerdeka.kemdikbud.go.id/program/magang/browse/863c3409-8b4e-4c96-9edd-71ee61e9fc41/5bea9d0a-e65e-11ee-826e-82a549dac64f">
                                    <p className="msibtxtcont">Apply Now</p>
                                    </a>
                                </button>
                        </div>
            ...
            <div className="flex w-full justify-center mt-10">
                ...
                <div className="card cardhome w-[100%] h-[357px]  rounded-[44px] image-full">
                        ...
                        <div className="card-body">
                            <h4 className="card-title text-white ml-5 mt-5">MAGANG<img src='/assets/home/iconarrowup.svg' alt="" className="absolute right-0 mr-5" /></h4>
                                <h1 className="text-left ml-5 mt-10 text-white text-[30px] font-bold font-['Montserrat']">Education Management</h1>
                                <button className="w-[130px] h-[50px] rounded-[44px] items-center mt-60 right-0 absolute mr-10 m-1 btn btcat btn-outline">
                                <a href="https://kampusmerdeka.kemdikbud.go.id/program/magang/browse/863c3409-8b4e-4c96-9edd-71ee61e9fc41/5e08c78a-f0a2-11ee-8773-32b7bdeb41bc">
                                    <p className="msibtxtcont">Apply Now</p>
                                    </a>
                                </button>
                        </div>
                ...
                <div className="mr-5 w-[100%]">
                   <div className="card cardhome w-[100%] h-[357px]  rounded-[44px] image-full">
                        ...
                        <div className="card-body">
                            <h4 className="card-title text-white ml-5 mt-5">MAGANG<img src='/assets/home/iconarrowup.svg' alt="" className="absolute right-0 mr-5" /></h4>
                                <h1 className="text-left ml-5 mt-10 text-white text-[30px] font-bold font-['Montserrat']">Stategic Project Officer</h1>
                                <button className="w-[130px] h-[50px] rounded-[44px] items-center mt-60 right-0 absolute mr-10 m-1 btn btcat btn-outline">
            ...
            <div className="flex w-full justify-center mt-10">
                ...
                <div className="mr-5 w-[100%]">
                   <div className="card cardhome w-[100%] h-[357px]  rounded-[44px] image-full">
                        ...
                        <div className="card-body">
                            <h4 className="card-title text-white ml-5 mt-5">MAGANG<img src='/assets/home/iconarrowup.svg' alt="" className="absolute right-0 mr-5" /></h4>
                                <h1 className="text-left ml-5 mt-10 text-white text-[30px] font-bold font-['Montserrat']">Mobile Development : Assistent Mentoring Technical</h1>
                                <button className="w-[130px] h-[50px] rounded-[44px] items-center mt-60 right-0 absolute mr-10 m-1 btn btcat btn-outline">
            ...
            <div className="flex w-full justify-center mt-10">
                <div className="mr-5 w-[100%]">
                <div className="card cardhome w-[100%] h-[357px]  rounded-[44px] image-full">
                        <figure><img src="public/assets/msib/DSC03030.JPG" alt="Shoes" /></figure>
                        <div className="card-body">
                            <h4 className="card-title text-white ml-5 mt-5">STUDI INDEPENDENT<img src='/assets/home/iconarrowup.svg' alt="" className="absolute right-0 mr-5" /></h4>
            ...
            <div className="flex w-full justify-center mt-10">
                <div className="mr-5 w-[100%]">
                <div className="card cardhome w-[100%] h-[357px]  rounded-[44px] image-full">
                        <figure><img src="public/assets/msib/Project Manager.JPG" alt="Shoes" /></figure>
                        <div className="card-body">
                            <h4 className="card-title text-white ml-5 mt-5">MAGANG<img src='/assets/home/iconarrowup.svg' alt="" className="absolute right-0 mr-5" /></h4>
            ...
            <div className="flex w-half justify-left mt-10">
                <div className="mr-5 w-[100%]">
                <div className="card cardhome w-[100%] h-[357px]  rounded-[44px] image-full">
                        <figure><img src="public/assets/msib/Public Relation.JPG" alt="Shoes" /></figure>
                        <div className="card-body">
