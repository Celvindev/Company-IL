        ...
        <>
            <div className="mr-5 w-[100%] ">
                <div className="grid w-[100%] h-[541.38px] place-items-center ">
                    ...
                    <div className="card w-[400px] h-[393px] -ml-40 crdminews breadcrumbs">
                        <div className="artboard">
                            <ul>
                                ...
                                <li> 
                                    <button className="w-[320px] h-[180px] rounded-[20px] items-center ml-5 mt-10 btn btn-outline "> 
                                        <p className="msibcrdtxt text-left ">
                                            <b className="cardtitle mr-30">Adi Prasetyo 
                                            </b>
                                            <div className="rating rating-xs">
                                            <input type="radio" name="rating-5" className="mask mask-star-2 bg-white-800" />
                                            <input type="radio" name="rating-5" className="mask mask-star-2 bg-white-800" />
                                            ...
                                            Infinite Learning menyediakan kursus yang luar biasa! Materi pelajarannya sangat terstruktur dengan baik dan disampaikan dengan jelas. Saya sangat terkesan dengan kualitas pembelajaran yang ditawarkan</p>
                                    </button>   
                                </li>   
                                ...
                                <li> 
                                    <button className="w-[320px] h-[180px] rounded-[20px] items-center ml-5 mt-10 btn btn-outline "> 
                                        <p className="msibcrdtxt text-left ">
                                            <b className="cardtitle mr-30">Ahmad Fauzi 
                                            </b>
                                            <div className="rating rating-xs">
                                            <input type="radio" name="rating-5" className="mask mask-star-2 bg-white-800" />
                                            <input type="radio" name="rating-5" className="mask mask-star-2 bg-white-800" />
                                            ...
                                            Pengalaman saya dengan Infinite Learning sungguh fantastis! Mereka memiliki beragam kursus yang relevan dengan kebutuhan pasar saat ini. Instruktur nya sangat berpengetahuan dan responsif.</p>
                                    </button>   
                                </li>   
                            </ul>
                            <button className="w-[140px] h-[20px] rounded-[44px] items-right ml-56 mt-5 btn btcat btn-outline"> 
